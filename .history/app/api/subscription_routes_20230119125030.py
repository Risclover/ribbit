...
def get_subscribers(id):
    ...
    return {"Subscriptions": [subscriber.to_dict().username for subscriber in subscribers]}
...
def get_user_subscriptions():
    ...
    return {"Subscriptions": [subscription.to_dict().username for subscription in users_subscriptions]}
