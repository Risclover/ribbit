...
class PostForm(FlaskForm):
    title = StringField(
        ...
        validators=[
            ...
            Length(min=1, max=300, message="Please give your post a title. Titles are limited to 300 characters."),
        ],
    )
...
class PostUpdateForm(FlaskForm):
    title = StringField("Title", validators=[DataRequired("Please give your post a title."),
            Length(min=1, max=300, message="Please give your post a title. Titles are limited to 300 characters.")])
    content = TextAreaField("Content", validators=[DataRequired("You must give your post some content."),
            Length(
                min=1, max=40000,
                message="Please give your post some content. Posts are limited to 40,000 characters.",
            )
