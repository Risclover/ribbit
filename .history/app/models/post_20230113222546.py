...
class Post(db.Model):
    ...
    updated_at = db.Column(db.DateTime, default=datetime.now, onupdate=db.func.current_timestamp())
    # # post_images = db.relationship('ImagePost', back_populates='image_post')
    # post_comments = db.relationship('Comment', back_populates='comment_posts', cascade="all, delete")
