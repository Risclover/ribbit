...
class Post(db.Model):
    ...
    post_downvoters = db.relationship('User', back_populates="user_post_upvotes", secondary=post_votes, lazy="joined")
    post_upvoters = db.relationship('User', back_populates="user_post_downvotes", secondary=post_votes, lazy="joined")
