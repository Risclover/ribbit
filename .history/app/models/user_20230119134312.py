...
class User(db.Model, UserMixin):
    ...
    subscriptions = db.relationship('Community', back_populates="subscribers", secondary=subscriptions, lazy="joined")
    ...
    def to_dict(self):
        return {
            ...
            'email': self.email,
            # 'subscriptions': {item.to_dict()["id"]: item.to_dict() for item in self.subscriptions}
