...
from .joins import subscriptions, post_votes
...
class User(db.Model, UserMixin):
    ...
    user_post_upvotes = db.relationship('Post', back_populates="post_upvoters", secondary=post_votes, lazy="joined")
    user_post_downvotes = db.relationship("Post", back_populates="post_downvoters", secondary=post_votes, lazy="joined")
