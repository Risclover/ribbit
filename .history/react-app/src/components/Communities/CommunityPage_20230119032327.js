          ...
          <div className="community-page-community-info">
            ...
            <div className="community-page-box-content">
              ...
              <div className="community-page-box-btn">
                {user && <NavLink to={`/posts/submit`}>
                  <button className="community-page-box-create-post">
                    Create Post
                  </button>}
                  {!user && <NavLink to={`/login`}><button className="community-page-box-create-post">Log In</button></NavLink>}
                </NavLink>
                {user && user?.id === community[0].userId ? (
