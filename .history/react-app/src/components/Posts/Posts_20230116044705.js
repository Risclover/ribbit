    ...
    <div className="posts-container">
      ...
      <div className="posts-right-col">
        ...
        <div className="posts-author-box">
          <h1>Created by Sara Dunlop</h1>
          <ul>
            <li className="tooltip">
              <span className="tooltiptext">Developer Portfolio</span>
              <a href="https://www.saradunlop.com" target="_blank">
                <img src={Resume} />
              </a>
            </li>
            <li className="tooltip">
            ...
            <li className="tooltip">
              <a href="https://www.github.com/Risclover" target="_blank">
                <img src={Github} />
              </a>
              <span className="tooltiptext">GitHub</span>
            </li>
            <li className="tooltip">
              <a href="mailto:sara091592@gmail.com" target="_blank">
                <img src={Email} />
              </a>
