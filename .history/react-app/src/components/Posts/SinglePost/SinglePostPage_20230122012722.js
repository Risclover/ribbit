  ...
  return (
    <div className="single-post-page">
      ...
      <div className="single-post-right-col">
        <NavLink to={`/c/${community.id}`}><div className="single-post-community-box">
          ...
          <div className="single-post-community-info-content">
            ...
            <div className="single-post-community-date">
              <img src={Cake} className="single-post-community-cake" /> Created{" "}
              {moment(community?.createdAt).format("MMM DD, YYYY")}
            </div>
