        ...
        <div className="single-post-container">
          ...
          <div className="single-post-main">
            ...
            {post.imgUrl ? (
              ...
              {isPage === "all" &&               <div className="single-page-content">{post.content}</div>}
              {isPage === "singlepage" &&               <div className="single-page-content">{post.content}</div>}
              {isPage === "community" &&               <div className="single-page-content">{post.content}</div>}
            )}
