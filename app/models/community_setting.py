...
class CommunitySettings(db.Model):
    ...
    base_color = db.Column(db.String(50), default="var(--highlight-color)", nullable=False)
    highlight = db.Column(db.String(50), default="var(--highlight-color)", nullable=False)
    bg_color = db.Column(db.String(50), default="#dae0e6", nullable=False)
    ...
    banner_color = db.Column(db.String(50), default="#33a8ff", nullable=False)
    ...
    active_link_color = db.Column(db.String(50), default="var(--highlight-color)", nullable=False)
    inactive_link_color = db.Column(db.String(50), default="var(--highlight-color)", nullable=False)
    hover_link_color = db.Column(db.String(50), default="var(--highlight-color)", nullable=False)
    menu_bg_color = db.Column(db.String(50), default="#dbf0ff", nullable=False)
    submenu_bg_color = db.Column(db.String(50), default="#dbf0ff", nullable=False)

    post_title_color = db.Column(db.String(50), default="#222222", nullable=False)
    ...
    upvote_count_color = db.Column(db.String(50), default="#FF4500", nullable=False)
    downvote_count_color = db.Column(db.String(50), default="#7193FF", nullable=False)
    post_bg_color = db.Column(db.String(50), default="#FFFFFF", nullable=False)
