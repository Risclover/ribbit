...
def seed_commentvotes():
    db.session.add_all([
        #----------------------- COMMENT 1 - POST 1 COMMENT 1 || Votes: 2 (+4, -2) -----------------------#
        ...
        #----------------------- COMMENT 10 - POST 2 COMMENT 2 || Votes: 2 (+4, -2) -----------------------#
        CommentVote(user_id=10, comment_id=9, is_upvote=True),
        CommentVote(user_id=37, comment_id=9, is_upvote=True),
        CommentVote(user_id=38, comment_id=9, is_upvote=True),
        CommentVote(user_id=39, comment_id=9, is_upvote=True),
        CommentVote(user_id=40, comment_id=9, is_upvote=False),
        CommentVote(user_id=41, comment_id=9, is_upvote=False),
    ])
    db.session.commit()
