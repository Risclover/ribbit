...
def seed_followers():
    ...
    demo.followed.extend([marnie, bobbie, user_4, user_7, user_10, user_14, user_19, user_23, user_25, user_30, user_31, user_38, user_42, user_44, user_50])
    marnie.followed.extend([demo, bobbie, user_5, user_6, user_9, user_15, user_20, user_24, user_26, user_32, user_39, user_43, user_45])
    bobbie.followed.extend([demo, marnie, user_8, user_11, user_16, user_21, user_27, user_33, user_40, user_46])
    user_4.followed.extend([demo, marnie, bobbie, user_12, user_17, user_22, user_28, user_34, user_41, user_47])
    ...
    user_9.followed.extend([marnie, user_6, user_11, user_16, user_21, user_26, user_31, user_36, user_41, user_46])
    ...
    user_14.followed.extend([marnie, user_12, user_22, user_32, user_42])
    ...
    user_24.followed.extend([marnie, user_7, user_16])
    user_25.followed.extend([demo, user_8, user_17])
    user_26.followed.extend([marnie, user_9, user_18])
    ...
    user_32.followed.extend([marnie, user_10, user_14])
    ...
    user_39.followed.extend([marnie, user_7, user_21])
    ...
    user_43.followed.extend([marnie, user_11, user_15])
    user_44.followed.extend([demo, user_7, user_16])
    user_45.followed.extend([marnie, user_8, user_17])
